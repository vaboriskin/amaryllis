        ...
        <div className="container">
          <div className="promotion-card">
            <div className="promotion-content">
              <h2 className="promotion-title">Акция «Мы с Тамарой ходим парой!»</h2>
              <p className="promotion-description">
                🌞🌞🌞Встречайте лето с лёгкостью и энергией!
              </p>
              <p className="promotion-description">
                Приглашаем вас в клинику «Амариллис» на сеанс классического массажа спины! Лето — время ярких эмоций, и мы поможем вам встретить его с бодростью и отличным настроением.
              </p>
              <p className="promotion-description">
                👯 Акция «Мы с Тамарой ходим парой!»
              </p>
              <p className="promotion-description">
                Приведите с собой подругу или друга, и мы подарим вам второй сеанс массажа спины (30 минут) бесплатно!
              </p>
              <p className="promotion-description">
                <strong>Как получить подарок:</strong>
              </p>
              <ol>
                <li>У вас должна быть активная запись на массаж.</li>
                <li>Ваш друг или подруга при записи называет ваши имя и фамилию.</li>
              </ol>
              <p className="promotion-description">
                <strong>Подарок:</strong> 30 минут массажа спины от мастера Оскара Фаритовича Латыпова.
              </p>
              <p className="promotion-description">
                <strong>Сроки акции:</strong> с 25 мая по 5 июня 2026 года.
              </p>
              <p className="promotion-description">
                Обязательна предварительная запись!
              </p>
              <p className="promotion-description">
                🌿 Погрузитесь в мир здоровья и гармонии
              </p>
              <p className="promotion-description">
                Почувствуйте силу и уверенность рук нашего мастера. Ручные техники массажа — это не просто механическое воздействие, это передача здоровой энергии, которая наполняет ваше тело силой.
              </p>
              <p className="promotion-description">
                <strong>Что вы получите:</strong>
              </p>
              <ul>
                <li>Здоровый позвоночник и лёгкая походка.</li>
                <li>Снятие спазмов, усталости и отёчности.</li>
                <li>Активизация жизненных процессов и нервной системы.</li>
                <li>Наполнение мышц кислородом и энергией.</li>
              </ul>
              <p className="promotion-description">
                Ваши спинки будут довольны! Врачи нашей клиники с радостью проконсультируют вас по всем вопросам.
              </p>
              <p className="promotion-description">
                Запись на массаж с понедельника по пятницу с 17.00 до 20.00 часов.
              </p>
              <p className="promotion-description">
                Встречайте яркое лето с лёгкой спиной и отличным самочувствием!
              </p>
